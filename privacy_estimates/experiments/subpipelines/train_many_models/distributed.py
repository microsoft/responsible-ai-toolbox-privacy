...
from privacy_estimates.experiments.loaders import (
    TrainingComponentLoader, InferenceComponentLoader, TrainSingleModelAndPredictLoader
)
...
class TrainModelGroupDistributedLoader(TrainModelGroupBase):
    def __init__(self, num_models: int, group_size: int, single_model_arguments: TrainSingleModelAndPredictArguments):
        ...
        self.train_model_and_predict_loader = TrainSingleModelAndPredictLoader(argumetns=single_model_arguments)
