...
class TestPrepareData:
    ...
    def test_partitioned_selection_no_merge(self):
        in_out_data, in_indices, out_indices, train_base_data, validation_base_data = (
            self.generate_data_for_partitioned_selection()
        )
    ...
    def test_partitioned_selection_merge_all_with_train(self):
        ...
        result = self.run(in_out_data, in_indices, out_indices, train_base_data, validation_base_data, seed=42,
                          ...
                          merge_unused_samples="all_with_train")
    ...
    def autogenerated_test_prepare_data(self):
        ...
        validation_sample_indices = set(
            zip(validation_data_for_model_ds["split"], validation_data_for_model_ds["sample_index"])
        )
